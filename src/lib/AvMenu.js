...
const canScreenShare = () => {
  if (browserDetails && browserDetails.browser === 'safari') {
    return false;
  }
  if (browserDetails && browserDetails.browser === 'firefox') {
    return false;
  }
...
const init = (cameras,mics,camCallback,micCallback) => {
  ...
  //   camCallback(camera);
  // });
  //   camCallback(cameras[0].split("_")[1]);
